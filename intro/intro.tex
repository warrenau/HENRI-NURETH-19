...
\begin{figure}[htbp]
    \vspace{16pt}
    \centering
    \includegraphics[width=0.75\textwidth]{intro/plots/Transient_Reactor_RIA_comp.jpg}
    \caption{[NEED diff plot, this is blurry, try to find og nureth plot.]Comparison of contemporary reactor transient conditions \cite{BESS2019}.}
